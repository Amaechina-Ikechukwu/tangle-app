...
const Step8 = ({ nextStep, images, setImages, prevStep, step }) => {
  ...
  const handleImageUpload = async () => {
    ...
    if (imageurl) {
      ...
      showNotification("Add an image and wait for upload");
    }
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        ...
        <TouchableOpacity style={styles.nextButton} onPress={handleImageUpload}>
